...
it('should handle sequences of events by when the previous one is done', function (callback) {
	...
	it('should fail to subscribe to an event', function(callback) {
    	...
    	freebase_client.load({plugin:freebase.client_plugins.intra_process, context:freebaseInstance}, function(e, badclient){

    		badclient.connectionId = 'rubbish'; //we put in a rubbish token
