	...
	*/
	it('should initialize the clients', function(callback) {
		...
		try{
		  ...
		  publisherclient = new freebase.client({plugin:freebase.client_plugins.intra_process, context:freebaseInstance}, function(e){

		    if (e)
		      return callback(e);

		    listenerclient = new freebase.client({plugin:freebase.client_plugins.intra_process, context:freebaseInstance}, function(e){
		        callback(e);
		    });
...
//	We are testing the deletion of data at a set path, and listening for the DELETE event at that path.
	...
	it('should fail to subscribe to an event', function(callback) {
    	...
    	new freebase.client({plugin:freebase.client_plugins.intra_process, context:freebaseInstance}, function(e, badclient){
