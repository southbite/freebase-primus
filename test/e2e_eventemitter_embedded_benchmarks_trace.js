  ...
  */
  it('should initialize the clients', function(callback) {
    ...
    try{
      ...
      publisherclient = new freebase.client({plugin:freebase.client_plugins.intra_process, context:freebaseInstance}, function(e, stressTestClient){

        if (e)
          return callback(e);

        listenerclient = new freebase.client({plugin:freebase.client_plugins.intra_process, context:freebaseInstance}, function(e, stressTestClient){
            callback(e);
        });
  ...
  it('should handle sequences of events by writing as soon as possible -slow?', function (callback) {
    ...
    new freebase.client({plugin:freebase.client_plugins.intra_process, context:freebaseInstance}, function(e, stressTestClient){
