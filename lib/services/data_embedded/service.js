    ...
    try{
        ...
        if (message.action == 'GET'){
            ...
            try{
                ...
                if (cursor.exec){//are we using the embedded library?
            ...
            var regularPUT = function(){
                ...
                var upsert = function(){
                    ...
                    _this.db.update({path:message.path}, setParameters, {upsert:true}, function(e, response) {
                        ...
                        if (!e){
                            ...
                            if (!dataWasMerged && !params.tag){ // no prefetched object, and we dont need to tag - we need to fetch the object
                                ...
                                setData.path = message.path;

                                if (params.excludeId){
                                     callback(null, setData);
                                }
                                else
                                    _this.getOneByPath(message.path, {_id:1}, function(e, fetchedResponse){
                ...
                if (params.merge){
                    ...
                    ////////////////////console.log('GETTING ARRAY BY PATH');
                     _this.getOneByPath(message.path, null, function(e, result){
            ...
            if (message.params.child_id){
                 ...
                 _this.db.update({path:message.path}, { $pull: { data: {'_id':message.params.child_id}}}, function(err, updated){
