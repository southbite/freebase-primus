...
module.exports = {
    ...
    upsert:function(path, data, options, callback){
        ...
        ////console.log('in data upsert');
        ////console.log([path, data, options]);

        var regularPUT = function(){

            ////console.log('in regular put');
            ////console.log([path, data, options]);
            ...
            var setData = {"data":data, modified:timestamp, path:path};
        ...
        if (options.set_type == 'child'){
            ...
            _this.db.update({path:path}, {$push: {data:posted}}, {upsert:true}, function(err, updatedCount) {
