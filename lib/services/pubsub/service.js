...
module.exports = {
    ...
    getListenerDict:function(path){
        ...
        if (path == '/ALL@*')
            return _this.listeners_all;

        if (path.indexOf('*') > -1)
            return _this.listeners_wildcard;
    ...
    addListener:function(path, sessionToken){
       ...
       if (path == '/ALL@*')
            return _this.listeners_all[sessionToken] = 1;
    ...
    publish:function(message, payload){
        ...
        ///SET@/mesh/system/requests/testMesh/freebaseClient/*
        ///SET@/mesh/system/requests/testMesh/freebaseClient/*
        ///SET@/mesh/system/requests/testMesh/freebaseClient/set
