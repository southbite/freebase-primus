...
module.exports = {
    ...
    onDisconnect:function(socket){
        ...
        for (var path in Object.keys(_this.listeners)){
            _this.removeListener(path, socket.id);
        }
    },
    addListener:function(path, connectionId){
        ...
        //_this.connections[connectionId].write({"type":"listener-added", "path":path});
    },
    ...
    publish:function(event){
        ...
        var message = {"type":"event", "payload":event.payload, "timestamp":utc.valueOf(), "action":event.action};
        var originalPath = event.path.toString();

        ////console.log('publishing...');
        ////console.log(message);
        ////console.log(_this.listeners);
        //////console.log(_this.listeners[event.path]);
