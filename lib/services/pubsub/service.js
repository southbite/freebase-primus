...
module.exports = {
	...
	handleDataResponse: function(e, message, response, eventSource) {
		...
		_this.utils.log('handleDataResponse', 'trace', 'service-pubsub', arguments);
	...
	onDisconnect: function(socket) {
		_this.utils.log('onDisconnect', 'trace', 'service-pubsub', arguments);
	...
	publish: function(message, payload) {
		...
		for (var listenerPath in _this.listeners_wildcard) {
			if (wildcard(channel, listenerPath)) {
				_this.emitToAudience(_this.listeners_wildcard[listenerPath],
					publication, listenerPath);
			}
		}
	}
}