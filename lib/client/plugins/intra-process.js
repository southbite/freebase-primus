module.exports = {
	...
	set:function(path, data, options, handler){
		...
		//_this.handleDataResponse(null, path, data, options, 'PUT', handler);
		
		/*

	{ payload: { property1: 'NybaMo2qbI-' },
  path: '/PUT@/e2e_test1/testsubscribe/sequence',
  action: 'PUT',
  params: { excludeId: 1 } }

		{ payload: 
   { data: { property1: 998 },
     modified: 1429019615732,
     path: '/e2e_test1/testsubscribe/sequence1' },
  path: '/PUT@/e2e_test1/testsubscribe/sequence1',
  action: 'PUT',
  params: { excludeId: 1 } }
  */
