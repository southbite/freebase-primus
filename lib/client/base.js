function FreebaseClient(options, initializedCallback){
	...
	_this.off = function(path, parameters, done){
		...
		try{
			...
			_this.performRequest(path, 'off', {"token":_this.token}, null, function(e, response){
				...
				if (_this.events[path]) delete _this.events[path];
